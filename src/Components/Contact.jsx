...
const Contact = () => {
    useTitle("Contact")
    return (
        <section className="py-6  font-semibold my-32 ">
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                ...
                <form novalidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <button type="button" className="self-center px-8 py-3 text-lg focus:ring hover:ring focus:ring-opacity-75 bg-orange-700 text-white w-full rounded-xl   hover:bg-orange-700">Submit</button>
                </form>
            </div>
        </section>
    );
